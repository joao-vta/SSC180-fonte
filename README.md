...
## Especificações
> A fonte espera como entrada uma tensão alternada efetiva de 127v com frequência de 60hz, como provida em diversas redes pelo país. Ela gera uma tensão regulavel que vai de 3v até 12v, e provê um mínimo de 100mA. Para efeitos de calculo, consideramos a carga máxima como 200mA, de modo a dar margem de segurança.
